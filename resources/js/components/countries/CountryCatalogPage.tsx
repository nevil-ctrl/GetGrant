...
export function CountryCatalogPage() {
  ...
  if (loading) return <p className="text-center mt-16">Загрузка стран…</p>;
  if (error) return <p className="text-center mt-16 text-red-500">{error}</p>;

  // Если выбрана страна, показываем детальную страницу
  if (selectedCountry) {
    return (
  ...
  // Основной каталог стран
  return (
    <div className="min-h-screen bg-[#F5F5F5] py-8 container-custom">
              ...
              <GetGrantCardContent>
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#1A1A1A] mb-1">{country.name}</h2>
