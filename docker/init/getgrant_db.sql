...
CREATE SEQUENCE public.jobs_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE ONLY public.cache_locks ADD CONSTRAINT cache_locks_pkey PRIMARY KEY (key);
